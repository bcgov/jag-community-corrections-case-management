...
public interface ClientMapper {
    ...
    @Mapping(target = "address", expression = "java(ca.bc.gov.open.jag.api.util.MappingUtils.stringToAddressList(client.getAddress(), client.getAddressType(), client.getAddressStatus()))")
