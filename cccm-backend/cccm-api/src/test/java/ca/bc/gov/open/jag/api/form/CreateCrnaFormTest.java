...
@QuarkusTest
public class CreateCrnaFormTest {
    ...
    public void testSuccess() {
        ...
        Mockito.when(clientFormSaveService.createCRNA(Mockito.any(), Mockito.any())).thenReturn(BigDecimal.ONE);
        ...
        BigDecimal result = sut.createCrnaForm(createFormInput, "123");
    ...
    public void addTestExceptionBadRole() {
        ...
        Assertions.assertThrows(ForbiddenException.class, () -> sut.createCrnaForm(new CreateFormInput(),"TEST"));
    ...
    public void addTestExceptionNoToken() {
        ...
        Assertions.assertThrows(UnauthorizedException.class, () -> sut.createCrnaForm(new CreateFormInput(),"TEST"));
