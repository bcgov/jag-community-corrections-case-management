...
@QuarkusTest
public class CreateSaraFormTest {
    ...
    public void testSuccess() {
        ...
        Mockito.when(clientFormSaveService.createSARA(Mockito.any(), Mockito.any())).thenReturn(BigDecimal.ONE);
        ...
        BigDecimal result = sut.createSaraForm(createFormInput, "123");
    ...
    public void addTestExceptionBadRole() {
        ...
        Assertions.assertThrows(ForbiddenException.class, () -> sut.createSaraForm(new CreateFormInput(),"TEST"));
    ...
    public void addTestExceptionNoToken() {
        ...
        Assertions.assertThrows(UnauthorizedException.class, () -> sut.createSaraForm(new CreateFormInput(),"TEST"));
