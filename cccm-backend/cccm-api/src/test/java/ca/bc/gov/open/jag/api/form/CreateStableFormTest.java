...
@QuarkusTest
public class CreateStableFormTest {
    ...
    public void testSuccess() {
        ...
        Mockito.when(clientFormSaveService.createStable(Mockito.any(), Mockito.any())).thenReturn(BigDecimal.ONE);
        ...
        BigDecimal result = sut.createStableForm(createFormInput, "123");
    ...
    public void addTestExceptionBadRole() {
        ...
        Assertions.assertThrows(ForbiddenException.class, () -> sut.createStableForm(new CreateFormInput(),"TEST"));
    ...
    public void addTestExceptionNoToken() {
        ...
        Assertions.assertThrows(UnauthorizedException.class, () -> sut.createStableForm(new CreateFormInput(),"TEST"));
