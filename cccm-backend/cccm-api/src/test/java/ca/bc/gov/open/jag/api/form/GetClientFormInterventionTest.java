...
@QuarkusTest
public class GetClientFormInterventionTest {
    ...
    public void addTestExceptionBadRole() {
        ...
        Assertions.assertThrows(ForbiddenException.class, () -> sut.getClientFormIntervention("TEST", BigDecimal.ONE, null, null));
    ...
    public void addTestExceptionNoToken() {
        ...
        Assertions.assertThrows(UnauthorizedException.class, () -> sut.getClientFormIntervention("TEST", BigDecimal.ONE, null, null));
