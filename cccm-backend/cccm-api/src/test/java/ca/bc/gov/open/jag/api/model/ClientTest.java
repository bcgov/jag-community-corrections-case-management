...
public class ClientTest {
    ...
    public void testClientModel() {
        ...
        sut.setAddressExpiry(TEST_DATE);
        ...
        Assertions.assertEquals(TEST_DATE, sut.getBirthDate());
        ...
        Assertions.assertEquals(TEST_DATE, sut.getAddressExpiry());
