<template>
  <div class="divTable">
    <div class="divTableBody">
      <div class="saveIndicator">  <v-progress-circular
      indeterminate v-if="saveInProgress"
      color="green"
    ><v-tooltip>Saving</v-tooltip></v-progress-circular></div>
      <div class="divTableRowL1 divTableRowNav">

        <div class="divTableCell">
          <span>
            <a v-for="(values, name, sectionIndex) in sectionQuestionMap" :key="sectionIndex"
      ...
      <div class="divTableRowL2 divTableRowNav">
        <div v-for="(values, name, sectionIndex) in sectionQuestionMap" :key="sectionIndex"
          ...
          <span>
            <a v-for="(value, questionIndex) in values.questions" :key="questionIndex"
...
export default {
  ...
  watch: {
    currentSection() {
      console.log("section %d", this.currentSection);
      this.currentSectionParent = this.currentSection - 1;
    },
    parentNavMoveToNext() {
  ...
  methods: {
    ...
    moveToSectionAndQuestion(section: number, question: number) {
      console.log("moveToSectionAndQuestion(%d,%d)", section, question);
    },
