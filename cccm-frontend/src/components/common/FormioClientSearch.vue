      ...
      if (this.clients != null) {
        for (let el of this.clients) {
          if (el.clientNum == clientNum) {
            ...
            el.currentName = "Ross, Bob";
            el.alias = "Bob, Smith Roger, Clements";
            let sampleAddress = 
                [
                    {
            ...
            if (el.address == null) {
              //clone the array
              el.address = [...sampleAddress];
            } else {
              // append both array
              el.address = el.address.concat(sampleAddress);
            }
            // TO BE REMOVED END.
        ...
        [
          {
            ...
            "alias": "Bob, Smith Roger, Clements",
